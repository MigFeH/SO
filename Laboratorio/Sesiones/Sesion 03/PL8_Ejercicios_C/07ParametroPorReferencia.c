...
void sustituyeEnteroPorSuCuadradoValor(int);
void sustituyeEnteroPorSuCuadradoRef(int *);
...
void main (int argc, char *argv[]) {
  ...
  sustituyeEnteroPorSuCuadradoRef(&longitud);
  sustituyeEnteroPorSuCuadradoValor(longitud);

  printf("La longitud de la cadena al cuadrado es %d\n",longitud);
  exit(1);
}

void sustituyeEnteroPorSuCuadradoValor(int longi) {
  longi *= longi;
}

void sustituyeEnteroPorSuCuadradoRef(int *longi) {
