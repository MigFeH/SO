...
// Inicio V4-ej1(a)
enum EXCEPTIONS {DIVISIONBYZERO, INVALIDPROCESSORMODE, INVALIDADDRESS, INVALIDINSTRUCTION}; // definimos el enumerado para poder distinguir diferentes tipos de excepciones que se van a lanzar
// Fin V4-ej1(a)
